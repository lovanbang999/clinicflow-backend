...
export class AdminController {
   ...
   * Stat cards for the Doctor Management page.
   */
  ...
  @ApiResponse({ status: 403, description: 'Forbidden — ADMIN role required' })
  getDoctorStatistics() {
    return this.adminService.getDoctorStatistics();
  }
  ...
  getDoctors(@Query() filterDto: FilterDoctorDto) {
    return this.adminService.findAllDoctors(filterDto);
  }
  ...
  toggleDoctorStatus(
    ...
    return this.adminService.toggleDoctorActive(id, dto);
  }
}
